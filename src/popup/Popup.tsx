// ---------------------------------------------------------------------------
// Extension popup — quick access only. The full app opens in a Chrome tab.
// ---------------------------------------------------------------------------
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '12px 14px', background: '#fff', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="row" style={{ gap: 6, marginTop: 2 }}>
            ...
            <Badge color={orders.some((o) => o.printed !== 'Printed' && o.orderStatus === 'New') ? 'orange' : 'gray'}>
              {orders.filter((o) => o.printed !== 'Printed' && o.orderStatus === 'New').length} new
            </Badge>
          </div>
        </div>
